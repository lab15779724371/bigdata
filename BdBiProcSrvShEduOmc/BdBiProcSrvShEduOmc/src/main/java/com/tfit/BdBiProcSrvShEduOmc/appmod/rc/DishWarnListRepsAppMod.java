...
//排菜周报表
public class DishWarnListRepsAppMod {
	private static final Logger logger = LogManager.getLogger(DishWarnListRepsAppMod.class.getName());
	...
	DishWarnListRepsOutDto ppDishWeekFromHive(String[] dates, 
		...
		warnCommonLicDets = dbHiveWarnService.getWarnLicDetsList(6,null,listYearMonth, startDate,
				...
				inputObj.getDepartmentId(),null,null,null,"1",warnLevelName,

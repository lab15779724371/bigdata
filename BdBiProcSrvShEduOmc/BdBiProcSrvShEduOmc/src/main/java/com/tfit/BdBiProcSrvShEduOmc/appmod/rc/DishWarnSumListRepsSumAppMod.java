...
//排菜周报表
public class DishWarnSumListRepsSumAppMod {
	private static final Logger logger = LogManager.getLogger(DishWarnSumListRepsSumAppMod.class.getName());
	...
	DishWarnSumListRepsSumOutDto ppDishWeekFromHive(String[] dates, 
		...
		AppTEduNoPlatoonCollectD appTEduNoPlatoonCollectDList = dbHiveWarnService.getAppTEduNoPlatoonCollectDListSum(listYearMonth, startDate, endDateAddOne, 
				inputObj);

...
public class SendUnacceptedWarningMod {

	private static final Logger logger = LogManager.getLogger(SendUnacceptedWarningMod.class.getName());
	// 是否为真实数据标识
...
//				String endDate = "2019-12-12";
				...
				// 更新状态为已读
				db2Service.getUpdateSysInfo("3", userINfo.getUserAccount(), task_time);

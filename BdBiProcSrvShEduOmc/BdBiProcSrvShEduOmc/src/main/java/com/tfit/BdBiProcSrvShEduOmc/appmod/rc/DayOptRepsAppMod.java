...
public class DayOptRepsAppMod {
	...
	private static WeeklyOptRepsDTO getReportList(String distId,String startDate, String endDate,String year,String month,String departmentId,Db1Service db1Service) {
		 ...
		 */
		String srcPathFileName = "/edu_day_report/shanghai";
		...
		if(dataList != null && dataList.size() >0) {
			for(String data : dataList) {
				...
				//2019年11月04日操作数据报告（上海市）
				wor.setRepName(startDt.toString("yyyy年MM月dd日")+"操作数据报告"+"("+datas[1]+")");
				wor.setRepUrl("");
				...
				wor.setDate(startDt.toString("yyyy/MM/dd"));
				weeklyOptReps.add(wor);
			}
		}
